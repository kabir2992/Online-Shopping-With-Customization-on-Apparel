			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="fname" class="form-control" name="firstname" pattern="^[a-zA-Z ]+$"  value="<?php echo $row["first_name"] . ' ' . $row["last_name"]; ?>">
						...
						<input type="text" id="adr" name="address" class="form-control" value="<?php echo  $row["address1"]; ?>" required>
						<label for="city"><i class="fa fa-institution"></i> City</label>
						<input type="text" id="city" name="city" class="form-control" value="<?php echo  $row["address2"] ;?>" pattern="^[a-zA-Z ]+$" required>
...
<!--                                                <div class="col-50">
							<label for="date">Enter Your Order Date</label>
							<input type="date" id="date" name="O_Date" class="form-control" required>
						</div>-->
						</div>
					</div>
					...
					<div class="col-50">
						...
						<input type="date" id="expdate" name="expdate" class="form-control" pattern="^((0[1-9])|(1[0-2]))\/(\d{2})$" placeholder="12/22">
...
?>
                                    ...
                                    Total Cart:- <input type="text"  name="total_count" value="<?php echo $total_count ;?>" readonly>
                                    Total Cart Amount:- <input type="text" id="total_price" name="total_price" value="<?php echo  $total ; ?>" readonly>
					
                                    <input type="submit" name="checkout" value="Continue to Checkout" class="checkout-btn">
				</form>
				</div>
			</div>
<?php 			
