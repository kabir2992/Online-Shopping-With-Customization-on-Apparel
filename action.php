...
if (isset($_POST["Common"])) {
    ...
    if (isset($_SESSION["uid"])) {
        ...
        $sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,a.discounted_price,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
    } else {
        //When user is not logged in this query will execute
        $sql = "SELECT a.product_id,a.product_title,a.product_price,a.product_image,a.discounted_price,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.ip_add='$ip_add' AND b.user_id < 0";
    }
    $query = mysqli_query($con, $sql);
    ...
    if (isset($_POST["checkOutDetails"])) {
        if (mysqli_num_rows($query) > 0) {
            ...
            if (!isset($_SESSION["uid"])) {
                ...
                $x = 0;
                $sql = "SELECT a.product_id,a.product_title,a.product_price,a.discounted_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
                $query = mysqli_query($con, $sql);
                while ($row = mysqli_fetch_array($query)) {
                    $x++;
                    $product_price = $row["product_price"];
